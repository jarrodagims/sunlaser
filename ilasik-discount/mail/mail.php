...
if(isset($_POST['email'])) {
	...
	$transport = Swift_SmtpTransport::newInstance('mail.edwardguillen.com', 25, 'tls' )
	  ->setUsername('mail@edwardguillen.com')     
	  ->setPassword('glomo87311')
	  ;
	...
	$message = Swift_Message::newInstance('A message from Sun Vision Laser Center')
