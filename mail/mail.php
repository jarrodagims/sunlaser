...
$recipientEmail             = 'myra.buruato@sunlaservision.com'; // REQUIRED value.
$recipientName              = 'SLVS';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'A message from your website'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'SLVS';                // REQUIRED value. This is used when a name or email is not collected from the website form

$timeZone					= 'US/Mountain';         // OPTIONAL, but some servers require this to be set. 
